...
import { isAuthenticated, validateBody, validateParams } from "@/infra/ValidationMiddleware";
import {
...
import { errorHandling } from "@/infra/helpers/ErrorHanding";
...
export default class Router {
  ...
  private setRoutes() {
    //Define as rotas dentro da nossa API
